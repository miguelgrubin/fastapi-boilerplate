from src.blog.domain.article import Article, ArticleUpdateParams
...
class ArticleUpdater(UseCase):
    def __init__(self, article_repository: ArticleRepository) -> None:
        self.article_repository = article_repository

    def execute(self, article_id: str, payload: ArticleUpdateParams) -> Article:
